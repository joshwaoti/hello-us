...
export default function Footer() {
  return (
    <footer className="bg-brand-charcoal text-brand-cream py-16 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-brand-beige max-w-sm">
          ...
          <div>
            ...
            <ul className="space-y-3 text-brand-beige">
              ...
              <li><Link href="/account" className="hover:text-brand-pink transition-colors">Order Tracking</Link></li>
